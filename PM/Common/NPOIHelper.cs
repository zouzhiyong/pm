...
namespace PM.Common
{
    public class NPOIHelper
    {
        ...
        public void RenderToExcel(DataTable table, HttpContext context, string fileName)
        {
        ...
        private void RenderToBrowser(MemoryStream ms, HttpContext context, string fileName)
        {
